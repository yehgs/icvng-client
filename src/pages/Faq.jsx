...
// Nigeria-authored FAQ answers. A handful reference Lagos/₦100,000/Nigeria
// facts directly — those are exactly the entries a Togo/Italy editor should
// override in Admin → Site Content → FAQ rather than inherit verbatim.
const DEFAULT_FAQS = [
...
const FAQ = () => {
  ...
  const faqs = get("faqs", DEFAULT_FAQS);
    ...
    <div className="bg-gray-50">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-wrap justify-center gap-4">
            {categories.map((category) => {
              const Icon = CATEGORY_ICONS[category.id] || FaQuestionCircle;
              return (
                <button
                  key={category.id}
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">{get("ctaTitle", DEFAULTS.ctaTitle)}</h2>
            <p className="text-xl text-green-100 mb-8">{get("ctaText", DEFAULTS.ctaText)}</p>

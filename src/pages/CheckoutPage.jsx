        ...
        <div className='w-full max-w-md bg-white py-4 px-2'>
          ...
          <div className='bg-white p-4'>
            ...
            <div className='flex gap-4 justify-between ml-1'>
              <p>Items total</p>
              <p className='flex items-center gap-2'><span className='line-through text-neutral-400'>{DisplayPriceInNaira(notDiscountTotalPrice)}</span><span>{DisplayPriceInNaira(totalPrice)}</span></p>
            </div>
            <div className='flex gap-4 justify-between ml-1'>
              <p>Quntity total</p>
